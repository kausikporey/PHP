...
<?php include_once('./include/header.php'); ?>
                    <header class="page-header page-header-dark bg-secondary">
                            ...
                            <div class="container">
                                <div class="row justify-content-center">
                                    <div class="col-xl-8 col-lg-10 text-center">
                                        ...
                                        <h1 class="page-header-title">Welcome to <?php echo $_GET['categories_name']; ?></h1>
                                        <p class="page-header-text mb-5">Are you searching for some content that you have not found yet? Try searching in the search box below!</p>
                                            ...
                                            <div class="form-row justify-content-center">
                                                <div class="col-lg-6 col-md-8">
                                                    <div  class="form-group mr-0 mr-lg-2">
                                                        ...
                                                        <input name = "categories_id" value="<?php echo $_GET['categories_id']; ?>"  type="hidden"/>
                                                    </div>
                                                </div>
                        ...
                        <?php
                                 ...
                                 $stmt->execute([':status' => 'Published',':id' => $_GET['categories_id']]);
                    ...
                    <section class="bg-white py-10">
                        ...
                        <hr />
                        <?php 
                            $sql = "SELECT * FROM posts WHERE post_category_id = :id AND post_status = :status ORDER BY post_views DESC LIMIT 1";
                            $stmt = $pdo->prepare($sql);
                            $stmt->execute([
                                    ...
                                    while($posts = $stmt->fetch(PDO::FETCH_ASSOC)){
                                        ...
                                        <div class="col-md-6 col-xl-4 mb-5">
                                            <a class="card post-preview lift h-100" href="single.php?post_id=<?php echo $post_id; ?>"
                                                ><img class="card-img-top" src="./img/<?php echo $post_image; ?>" alt="<?php echo 'Not Found'; ?>" />
                                                <div class="card-body">
                                                    <h5 class="card-title"><?php echo $post_title; ?></h5>
                                                    <p class="card-text">
                                                        <?php echo $post_details; ?>               
                                                ...
                                                <div class="card-footer d-flex align-items-center justify-content-between">
                                                    ...
                                                    <div class="post-preview-meta-details-view"><?php echo $post_views; ?></div>
                                                </div>
                                            </a>
                                        </div>
                                   <?php } ?>
                                        ...
                                        <?php
                                            ...
                                            if($previous<=0){
                                                ...
                                                echo '<li class="page-item">
                                                        <a class="page-link" href="categories.php?categories_id='.$_GET['categories_id'].'&categories_name='.$_GET['categories_name'].'&page='.$previous.'" aria-label="Previous"><span aria-hidden="true">&#xAB;</span></a>
                                                     </li>';
                                            }
                                        ?>
                                            ...
                                            if(isset($_GET['page'])){
                                                ...
                                                for($i = 1;$i <= $total_pager; $i++){
                                                    if($i == $active){
                                                        echo '<li class="page-item active"><a class="page-link" href="categories.php?categories_id='.$_GET['categories_id'].'&categories_name='.$_GET['categories_name'].'&page='.$i.'">'.$i.'</a></li>';
                                                    }else{
                                                        echo '<li class="page-item"><a class="page-link" href="categories.php?categories_id='.$_GET['categories_id'].'&categories_name='.$_GET['categories_name'].'&page='.$i.'">'.$i.'</a></li>';
                                                    }
                                                }
                                            ?>
                                            ...
                                            <?php 
                                                ...
                                                if($next-1 >= $total_pager){
                                                    ...
                                                    echo '<li class="page-item">
                                                            <a class="page-link" href="categories.php?categories_id='.$_GET['categories_id'].'&categories_name='.$_GET['categories_name'].'&page='.$next.'" aria-label="Next"><span aria-hidden="true">&#xBB;</span></a>
                                                          </li>';
                                                }
                                            ?>
                                        </ul>
                            ...
                            <div class="row">
                            <?php
                                $sql = "SELECT * FROM posts WHERE post_category_id = :id AND post_status = :status ORDER BY post_views DESC LIMIT 0,3";
                                $stmt = $pdo->prepare($sql);
                                $stmt->execute([
                                    ':id' => $_GET['categories_id'],
                                    ':status' => 'Published'
                            ...
                            <div class="row features text-center mb-5">
                                <?php 
                                    ...
                                    while($categories = $stmt->fetch(PDO::FETCH_ASSOC)){
                                            ...
                                            $categories_total_post = $categories['categories_total_posts'];
                                            $categories_id = $categories['categories_id'];
                                        ?>
                                        <div class="col-lg-4 col-md-6 mb-5">
                                            <a class="card card-link border-top border-top-lg border-primary h-100 lift" href="categories.php?categories_id=<?php echo $categories_id;?>&categories_name=<?php echo $categories_name;?>">
                                                <div class="card-body p-5">
                                                    <div class="icon-stack icon-stack-lg bg-primary-soft text-primary mb-4"><i data-feather="user"></i></div>
                                                    <h6><?php echo $categories_name; ?></h6>
                                                </div>
                                                <div class="card-footer bg-transparent pt-0 pb-5"><div class="badge badge-pill badge-light font-weight-normal px-3 py-2"><?php echo $categories_total_post; ?> Posts</div></div></a>
                                        </div>
                                    <?php } ?>
                            </div>    
                        </div>
