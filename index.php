...
<?php include_once('./include/header.php'); ?>
                    ...
                    <section class="bg-white py-10">
                        ...
                        <hr />
                        <?php 
                            $sql = "SELECT * FROM posts WHERE post_status = :status ORDER BY post_views DESC LIMIT 1";
                        ...
                        ?>
                                    ...
                                    <div class="col-lg-7">
                                        <div class="card-body">
                                            ...
                                            <div class="post-preview-meta">
                                                <img class="post-preview-meta-img" src="./backend/assets/img/<?php echo $post_author_image; ?>" />
                                        ...
                                        <?php
                                            ...
                                            if($previous<=0){
                                                ...
                                                echo '<li class="page-item">
                                                        <a class="page-link" href="index.php?page='.$previous.'" aria-label="Previous"><span aria-hidden="true">&#xAB;</span></a>
                                                     </li>';
                                            }
                                        ?>
                            ...
                            <div class="row">
                            <?php
                                $sql = "SELECT * FROM posts WHERE post_status = :status ORDER BY post_views DESC LIMIT 0,3";
                                $stmt = $pdo->prepare($sql);
                                $stmt->execute([':status' => 'Published']);
                                while($posts = $stmt->fetch(PDO::FETCH_ASSOC)){
                                    $post_title = $posts['post_title'];
