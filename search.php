...
<?php include_once('./include/header.php') ?>
                    <?php 
                        if(isset($_GET['key'])){
                            ...
                            $stmt->execute([':status' => "Published",':title' =>'%'.trim($keyword).'%']);
                            $count = $stmt->rowCount();
                            if($count == 0){
                                $post_found = 0;
                            }else{
                    ...
                    <section class="bg-white py-10">
                        <div class="container">
                            ...
                            <!-- for paginatioin -->
                            <?php
                                 $sql = "SELECT * FROM posts WHERE post_status = :status AND post_title LIKE :title ORDER BY post_id";
                                 $stmt = $pdo->prepare($sql);
                                 $stmt->execute([':status' => "Published",':title' =>'%'.trim($_GET['key']).'%']);
                                                        ...
                                                        <div class="card-footer">
                                                            <div class="post-preview-meta">
                                                                ...
                                                                <div class="post-preview-meta-details">
                                                                    ...
                                                                    <div class="post-preview-meta-details-date"><?php echo $post_date; ?> &#xB7; 5 min read</div>
                                                                </div>
                                                            </div>
                                                        </div></a>
                                                </div>
                                        ...
                                        <?php
                                            ...
                                            if($previous<=0){
                                                ...
                                                echo '<li class="page-item">
                                                        <a class="page-link" href="search.php?key='.$_GET['key'].'&page='.$previous.'" aria-label="Previous"><span aria-hidden="true">&#xAB;</span></a>
                                                     </li>';
                                            }
                                        ?>
